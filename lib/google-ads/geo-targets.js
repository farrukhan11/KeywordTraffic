// Geo target constants for country-level targeting, from the official
// Google Ads geotargets dataset (2026-07-16). Only entries with
// Target Type = Country and Status = Active are included.
...
export const COUNTRIES = Object.keys(COUNTRY_IDS).sort();
